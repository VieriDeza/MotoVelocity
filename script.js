...
function agregarAlCarrito(id) {
  ...
  if (existe) {
    mostrarToast(moto.marca + ' ' + moto.modelo + ' ya está en tu carrito.');
    return;
  }
  carrito.push({ id: moto.id, marca: moto.marca, modelo: moto.modelo, precio: moto.precio, img: moto.img });
  guardarCarrito();
  actualizarUICarrito();
  mostrarToast('✅ ' + moto.marca + ' ' + moto.modelo + ' añadido al carrito.');
}
